...
class BeanAnnotationChecker(
    ...
    override fun check(declaration: FirClass) {
        ...
        val beanName = beanAnnotation.getAnnotationFieldValue(Bean::name.name) ?: declaration.symbol.classId.shortClassName.toString().replaceFirstChar { it.lowercase() }
