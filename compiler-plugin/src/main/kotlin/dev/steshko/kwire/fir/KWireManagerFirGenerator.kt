...
class KWireManagerFirGenerator(
    session: FirSession,
    private val globalBeanConfigInternal: GlobalBeanConfigInternal
    ...
    override fun generateTopLevelClassLikeDeclaration(classId: ClassId): FirClassLikeSymbol<*>? {
        ...
        globalBeanConfigInternal.generateBeans(session)
    ...
    override fun generateProperties(
        ...
        return listOf(
            createMemberProperty(
                ...
                returnType = session.getClassSymbolFromFqn(globalBeanConfigInternal.beans.find { it.name == callableId.callableName.identifier }!!.fqName)!!.constructType()
            ).symbol
        )
    }
    ...
    override fun getCallableNamesForClass(classSymbol: FirClassSymbol<*>, context: MemberGenerationContext): Set<Name> {
        ...
        return globalBeanConfigInternal.beans.map {
